...
export default function Section2(){
  return(
    <section className="bg-white min-h-screen flex-center px-[40px]">
      <h1 class=" md:leading-[70px]">I have 
      ...
      <a href="" className=" underline flex gap-2 grad-text">see works <Image src="/icons/link.svg" width="20" height="20" alt="new tab"/> </a> 
      </h1>
